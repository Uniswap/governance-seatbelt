...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/site-packages/solc_select/solc_select.py", line 115, in get_available_versions
    available_releases.update(get_additional_linux_versions())
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/site-packages/solc_select/solc_select.py", line 123, in get_additional_linux_versions
  ...
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/urllib/request.py", line 525, in open
    response = meth(req, response)
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/urllib/request.py", line 634, in http_response
    response = self.parent.error(
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/urllib/request.py", line 563, in error
    return self._call_chain(*args)
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/urllib/request.py", line 496, in _call_chain
    result = func(*args)
  File "/opt/hostedtoolcache/Python/3.10.2/x64/lib/python3.10/urllib/request.py", line 643, in http_error_default
