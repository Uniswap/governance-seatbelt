## Risk Parameter Updates 2022-04-22
...
- Start Block: 14662589 (4/26/2022, 5:51:53 PM ET)
- End Block: 14681789 (4/29/2022, 6:09:22 PM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/1b5ef8a9-d86b-4a12-8d3e-e5e9e4c1b860](https://dashboard.tenderly.co/me/simulator/1b5ef8a9-d86b-4a12-8d3e-e5e9e4c1b860)
...
The full list of parameter updates can be found in the [forum](https://governance.aave.com/t/arc-risk-parameter-updates-2022-04-22/7911).
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756`
    - `CollateralConfigurationChanged(asset: 0xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f, ltv: 4900, liquidationThreshold: 6500, liquidationBonus: 10750)`
    - `CollateralConfigurationChanged(asset: 0xae7ab96520de3a18e5e111b5eaab095312d7fe84, ltv: 7300, liquidationThreshold: 7500, liquidationBonus: 10750)`
    - `CollateralConfigurationChanged(asset: 0x1f9840a85d5af5bf1d1762f925bdaddc4201f984, ltv: 6000, liquidationThreshold: 7500, liquidationBonus: 10900)`
...
```
Warning: contracts/protocol/lendingpool/LendingPoolConfigurator.sol: Warning: SPDX license identifier not provided in source file. Before publishing, consider adding a comment containing "SPDX-License-Identifier: <SPDX-License>" to each source file. Use "SPDX-License-Identifier: UNLICENSED" for non-open-source code. Please see https://spdx.org for more information.

Warning: contracts/protocol/lendingpool/LendingPoolConfigurator.sol: Warning: Source file does not specify required compiler version! Consider adding "pragma solidity ^0.6.12;"
...
[92m
VersionedInitializable (contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol#18-77) does not implement functions:
	- VersionedInitializable.getRevision() (contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol#56)
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#unimplemented-functions[0m
[92m
VersionedInitializable.______gap (contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol#76) is never used in VersionedInitializable (contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol#18-77)
...
0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521 analyzed (17 contracts with 78 detectors), 60 result(s) found
```
