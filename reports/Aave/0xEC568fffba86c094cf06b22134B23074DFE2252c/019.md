...
- Simulation: [https://dashboard.tenderly.co/me/simulator/ccc0edd7-2e0d-41c0-b059-f30ca40fe80b](https://dashboard.tenderly.co/me/simulator/ccc0edd7-2e0d-41c0-b059-f30ca40fe80b)
...
- No compiler warnings for VariableDebtToken (Aave variable debt bearing PAX) at `0x7b4E77aa7062cE6b8a8A75514F6D2aD987c0d854`
...
- No compiler warnings for StableDebtToken (Aave stable debt bearing PAX) at `0x9C3440F4aACA3312b632bE4A07C0f97B15c31c8b`
...
initialize(uint8,string,string) should be declared external:
	- DebtTokenBase.initialize(uint8,string,string) (contracts/protocol/tokenization/base/DebtTokenBase.sol#57-65)
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#public-function-that-could-be-declared-external[0m
0x9C3440F4aACA3312b632bE4A07C0f97B15c31c8b analyzed (17 contracts with 78 detectors), 81 result(s) found
```
...
decreaseAllowance(address,uint256) should be declared external:
	- IncentivizedERC20.decreaseAllowance(address,uint256) (contracts/protocol/tokenization/IncentivizedERC20.sol#152-166)
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#public-function-that-could-be-declared-external[0m
0xBcbD94007425001E9e2AEc764D799f83a257f050 analyzed (17 contracts with 78 detectors), 60 result(s) found
```
