...
- Simulation: [https://dashboard.tenderly.co/me/simulator/5f8e6a16-a756-477a-b0bc-5d1cd5115e68](https://dashboard.tenderly.co/me/simulator/5f8e6a16-a756-477a-b0bc-5d1cd5115e68)
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#unused-state-variable
0x1f57Cc62113C3a6346882DcF3Ed49120411ac2d2 analyzed (18 contracts with 75 detectors), 57 result(s) found
```
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#unused-state-variable
0x3b2a77058a1Eb4403a90b94585FaB16Bc512E703 analyzed (17 contracts with 75 detectors), 68 result(s) found
```
...
Variable BaseImmutableAdminUpgradeabilityProxy.ADMIN (contracts/protocol/libraries/aave-upgradeability/BaseImmutableAdminUpgradeabilityProxy.sol#17) is not in mixedCase
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions
0x619beb58998eD2278e08620f97007e1116D5D25b analyzed (6 contracts with 75 detectors), 17 result(s) found
```
...
Variable Errors.LP_INCONSISTENT_FLASHLOAN_PARAMS (contracts/protocol/libraries/helpers/Errors.sol#55) is too similar to Errors.VL_INCONSISTENT_FLASHLOAN_PARAMS (contracts/protocol/libraries/helpers/Errors.sol#100)
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#variable-names-too-similar
0x8Cae0596bC1eD42dc3F04c4506cfe442b3E74e27 analyzed (8 contracts with 75 detectors), 32 result(s) found
```
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions
0x986b5E1e1755e3C2440e960477f25201B0a8bbD4 analyzed (7 contracts with 75 detectors), 32 result(s) found
```
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#redundant-statements
0xA50ba011c48153De246E5192C8f9258A2ba79Ca9 analyzed (5 contracts with 75 detectors), 7 result(s) found
```
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#unused-state-variable
0xbd4765210d4167CE2A5b87280D9E8Ee316D5EC7C analyzed (26 contracts with 75 detectors), 80 result(s) found
```
...
Variable BaseImmutableAdminUpgradeabilityProxy.ADMIN (contracts/protocol/libraries/aave-upgradeability/BaseImmutableAdminUpgradeabilityProxy.sol#17) is not in mixedCase
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions
0xE4922afAB0BbaDd8ab2a88E0C79d884Ad337fcA6 analyzed (6 contracts with 75 detectors), 17 result(s) found
```
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#variable-names-too-similar
0xe5BbBdb2Bb953371841318E1Edfbf727447CeF2E analyzed (12 contracts with 75 detectors), 118 result(s) found
```
