...
- Simulation: [https://dashboard.tenderly.co/me/simulator/34b52d50-6563-428e-a8f9-f6eb4be41c62](https://dashboard.tenderly.co/me/simulator/34b52d50-6563-428e-a8f9-f6eb4be41c62)
...
```diff
# InitializableImmutableAdminUpgradeabilityProxy at `0x37D7306019a38Af123e4b245Eb6C28AF552e0bB0` with implementation PermissionedLendingPool at `0xfbF029508c061B440D0cF7Fd639e77Fb2E196241`
@@ _paused @@
- true
+ false
```
...
<details>
<summary>View warnings for InitializableImmutableAdminUpgradeabilityProxy at `0x37D7306019a38Af123e4b245Eb6C28AF552e0bB0` with implementation PermissionedLendingPool at `0xfbF029508c061B440D0cF7Fd639e77Fb2E196241`</summary>
...
<details>
<summary>View warnings for InitializableImmutableAdminUpgradeabilityProxy at `0x4e1c7865e7BE78A7748724Fa0409e88dc14E67aA` with implementation LendingPoolConfigurator at `0x8e5E28f273E3a6612A9C5d6F16aa67DA156042F4`</summary>
...
<details>
<summary>Slither report for InitializableImmutableAdminUpgradeabilityProxy at `0x37D7306019a38Af123e4b245Eb6C28AF552e0bB0` with implementation PermissionedLendingPool at `0xfbF029508c061B440D0cF7Fd639e77Fb2E196241`</summary>
...
INFO:Slither:0x37D7306019a38Af123e4b245Eb6C28AF552e0bB0 analyzed (6 contracts with 79 detectors), 17 result(s) found
```

</details>

<details>
<summary>Slither report for InitializableImmutableAdminUpgradeabilityProxy at `0x4e1c7865e7BE78A7748724Fa0409e88dc14E67aA` with implementation LendingPoolConfigurator at `0x8e5E28f273E3a6612A9C5d6F16aa67DA156042F4`</summary>
...
Variable BaseImmutableAdminUpgradeabilityProxy.ADMIN (contracts/protocol/libraries/aave-upgradeability/BaseImmutableAdminUpgradeabilityProxy.sol#17) is not in mixedCase
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions
INFO:Slither:0x4e1c7865e7BE78A7748724Fa0409e88dc14E67aA analyzed (6 contracts with 79 detectors), 17 result(s) found
```

</details>

<details>
<summary>Slither report for LendingPoolAddressesProvider at `0x6FdfafB66d39cD72CFE7984D3Bbcc76632faAb00`</summary>
...
INFO:Slither:0x6FdfafB66d39cD72CFE7984D3Bbcc76632faAb00 analyzed (10 contracts with 79 detectors), 24 result(s) found
```

</details>

<details>
<summary>Slither report for LendingPoolConfigurator at `0x8e5E28f273E3a6612A9C5d6F16aa67DA156042F4`</summary>
...
INFO:Slither:0x8e5E28f273E3a6612A9C5d6F16aa67DA156042F4 analyzed (21 contracts with 79 detectors), 69 result(s) found
```

</details>

<details>
<summary>Slither report for EnableArcProposal at `0xA7fC6E204c2069edb0ed5Fed451F419B985eC416`</summary>

```
INFO:Slither:0xA7fC6E204c2069edb0ed5Fed451F419B985eC416 analyzed (5 contracts with 79 detectors), 0 result(s) found
```
...
<details>
<summary>Slither report for PermissionedLendingPool at `0xfbF029508c061B440D0cF7Fd639e77Fb2E196241`</summary>
...
INFO:Detectors:
MockParaSwapTokenTransferProxy.transferFrom(address,address,address,uint256) (contracts/mocks/swap/MockParaSwapTokenTransferProxy.sol#9-16) uses arbitrary from in transferFrom: IERC20(token).transferFrom(from,to,amount) (contracts/mocks/swap/MockParaSwapTokenTransferProxy.sol#15)
LendingPool.flashLoan(address,address[],uint256[],uint256[],address,bytes,uint16) (contracts/protocol/lendingpool/LendingPool.sol#400-481) uses arbitrary from in transferFrom: IERC20(vars.currentAsset).safeTransferFrom(receiverAddress,vars.currentATokenAddress,vars.currentAmountPlusPremium) (contracts/protocol/lendingpool/LendingPool.sol#451-455)
...
INFO:Detectors:
PermissionedLendingPool (contracts/protocol/lendingpool/PermissionedLendingPool.sol#17-368) is an upgradeable contract that does not protect its initialize functions: LendingPool.initialize(ILendingPoolAddressesProvider) (contracts/protocol/lendingpool/LendingPool.sol#86-91). Anyone can delete the contract with: PermissionedLendingPool.liquidationCall(address,address,address,uint256,bool) (contracts/protocol/lendingpool/PermissionedLendingPool.sol#223-237)PermissionedLendingPool.seize(address,address[],address) (contracts/protocol/lendingpool/PermissionedLendingPool.sol#244-262)Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#unprotected-upgradeable-contract
INFO:Detectors:
...
Reentrancy in MockParaSwapAugustus.swap(address,address,uint256,uint256) (contracts/mocks/swap/MockParaSwapAugustus.sol#42-58):
	...
	MockParaSwapAugustus._expectingSwap (contracts/mocks/swap/MockParaSwapAugustus.sol#12) can be used in cross function reentrancies:
	- MockParaSwapAugustus.expectSwap(address,address,uint256,uint256,uint256) (contracts/mocks/swap/MockParaSwapAugustus.sol#27-40)
	- MockParaSwapAugustus.swap(address,address,uint256,uint256) (contracts/mocks/swap/MockParaSwapAugustus.sol#42-58)
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#reentrancy-vulnerabilities-1
INFO:Detectors:
...
Reentrancy in LendingPool.flashLoan(address,address[],uint256[],uint256[],address,bytes,uint16) (contracts/protocol/lendingpool/LendingPool.sol#400-481):
	External calls:
	- IAToken(aTokenAddresses[vars.i]).transferUnderlyingTo(receiverAddress,amounts[vars.i]) (contracts/protocol/lendingpool/LendingPool.sol#423)
...
INFO:Slither:0xfbF029508c061B440D0cF7Fd639e77Fb2E196241 analyzed (107 contracts with 79 detectors), 455 result(s) found
```
