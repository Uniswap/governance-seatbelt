...
- Start Block: 16035767 (11/23/2022, 5:49:23 PM ET)
- End Block: 16054967 (11/26/2022, 11:10:24 AM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/857e5d27-92d3-4ad4-9498-8b2cbe1b3d0e](https://dashboard.tenderly.co/me/simulator/857e5d27-92d3-4ad4-9498-8b2cbe1b3d0e)
...
A proposal to make parameter changes on Aave V2 ETH. Given that the market situation of these assets is currently volatile, out of an abundance of caution, we recommend temporarily freezing the following markets:
...
Freeze the YFI, CRV, ZRX, MANA, 1inch, BAT, sUSD, ENJ, GUSD, AMPL, RAI, USDP, LUSD, xSUSHI, DPI, renFIL, and MKR markets on Aave V2 ETH.

## Implementation

We freeze the YFI, CRV, ZRX, MANA, 1inch, BAT, sUSD, ENJ, GUSD, AMPL, RAI, USDP, LUSD, xSUSHI, DPI, renFIL, and MKR markets by calling the `freezeReserve` method on the `LendingPoolConfigurator`
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756` with implementation LendingPoolConfigurator at `0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521`
    ...
    - `ReserveFrozen(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52)`
...
crytic_compile.platform.exceptions.InvalidCompilation: Warning: contracts/protocol/libraries/configuration/ReserveConfiguration.sol: Warning: SPDX license identifier not provided in source file. Before publishing, consider adding a comment containing "SPDX-License-Identifier: <SPDX-License>" to each source file. Use "SPDX-License-Identifier: UNLICENSED" for non-open-source code. Please see https://spdx.org for more information.

Warning: contracts/protocol/libraries/configuration/ReserveConfiguration.sol: Warning: Source file does not specify required compiler version! Consider adding "pragma solidity ^0.6.12;"

DeclarationError: contracts/protocol/lendingpool/LendingPoolConfigurator.sol:10:1: DeclarationError: Declaration "ReserveConfiguration" not found in "contracts/protocol/libraries/configuration/ReserveConfiguration.sol" (referenced as "../libraries/configuration/ReserveConfiguration.sol").
