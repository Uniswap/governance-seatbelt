...
- End Block: 16054967 (11/26/2022, 11:18:22 AM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/8c239fea-e001-4ffc-b204-691ab5bfd7e1](https://dashboard.tenderly.co/me/simulator/8c239fea-e001-4ffc-b204-691ab5bfd7e1)
...
```
ERROR:CryticCompile:Warning: contracts/dependencies/openzeppelin/contracts/Address.sol: Warning: SPDX license identifier not provided in source file. Before publishing, consider adding a comment containing "SPDX-License-Identifier: <SPDX-License>" to each source file. Use "SPDX-License-Identifier: UNLICENSED" for non-open-source code. Please see https://spdx.org for more information.

Warning: contracts/dependencies/openzeppelin/contracts/Address.sol: Warning: Source file does not specify required compiler version! Consider adding "pragma solidity ^0.6.12;"

DeclarationError: contracts/dependencies/openzeppelin/contracts/SafeERC20.sol:7:1: DeclarationError: Declaration "Address" not found in "contracts/dependencies/openzeppelin/contracts/Address.sol" (referenced as "./Address.sol").
