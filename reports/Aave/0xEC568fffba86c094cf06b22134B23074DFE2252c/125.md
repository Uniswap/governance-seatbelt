...
_Updated as of block [16060323](https://etherscan.io/block/16060323) at 11/27/2022, 4:07:35 AM ET_
...
- Start Block: 16055505 (11/26/2022, 11:58:59 AM ET)
- End Block: 16074705 (11/29/2022, 8:03:41 AM ET)
- Targets: [0x53d3D14F9B2B8FE12D0DA6864c76eD565716570e](https://etherscan.io/address/0x53d3D14F9B2B8FE12D0DA6864c76eD565716570e#code)
- Executor: [0xEE56e2B3D491590B5b31738cC34d5232F378a8D5](https://etherscan.io/address/0xEE56e2B3D491590B5b31738cC34d5232F378a8D5) (Short executor)
- Simulation: [https://dashboard.tenderly.co/me/simulator/428f04ea-8378-4b9c-82a8-e123820314a0](https://dashboard.tenderly.co/me/simulator/428f04ea-8378-4b9c-82a8-e123820314a0)
...
- 64563969658674525508388
+ 64563681428298373796644
...
# decoded configuration.data for key `0xd5147bc8e386d91cc5dbe72099dac6c9b99276f5` (symbol: renFIL)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xd533a949740bb3306d119cc777fa900ba034cd52`.configuration.data @@
- 36893853548324920235388
+ 36893565317948768523644
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756` with implementation LendingPoolConfigurator at `0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521`
    - `ReserveFrozen(asset: 0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e)`
    - `ReserveUnfrozen(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52)`
    - `BorrowingDisabledOnReserve(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52)`
    - `ReserveFrozen(asset: 0xe41d2489571d322189246dafa5ebde1f4699f498)`
    - `ReserveFrozen(asset: 0x0f5d2fb29fb7d3cfee444a200298f468908cc942)`
    - `ReserveUnfrozen(asset: 0x111111111117dc0aa78b770fa6a738034120c302)`
    - `BorrowingDisabledOnReserve(asset: 0x111111111117dc0aa78b770fa6a738034120c302)`
    - `ReserveFrozen(asset: 0x0d8775f648430679a709e98d2b0cb6250d2887ef)`
    - `ReserveUnfrozen(asset: 0x57ab1ec28d129707052df4df418d58a2d46d5f51)`
    - `ReserveFrozen(asset: 0xf629cbd94d3791c9250152bd8dfbdf380e2a3b9c)`
    - `ReserveUnfrozen(asset: 0x056fd409e1d7a124bd7017459dfea2f387b6d5cd)`
    - `ReserveFrozen(asset: 0xd46ba6d942050d489dbd938a2c909a5d5039a161)`
    - `ReserveFrozen(asset: 0x03ab458634910aad20ef5f1c8ee96f1d6ac54919)`
    - `ReserveUnfrozen(asset: 0x8e870d67f660d95d5be530380d0ec0bd388289e1)`
    - `ReserveUnfrozen(asset: 0x5f98805a4e8be255a32880fdec7f6728c6568ba0)`
    - `ReserveFrozen(asset: 0x8798249c2e607446efb7ad49ec89dd1865ff4272)`
    - `ReserveUnfrozen(asset: 0x1494ca1f11d487c2bbe4543e90080aeba4ba3c2b)`
    - `ReserveFrozen(asset: 0xd5147bc8e386d91cc5dbe72099dac6c9b99276f5)`
    - `ReserveUnfrozen(asset: 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2)`
    - `BorrowingDisabledOnReserve(asset: 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2)`
    - `BorrowingDisabledOnReserve(asset: 0xc18360217d8f7ab5e7c516566761ea12ce7f9d72)`
    - `BorrowingDisabledOnReserve(asset: 0x514910771af9ca656af840dff83e8264ecf986ca)`
    - `BorrowingDisabledOnReserve(asset: 0x1f9840a85d5af5bf1d1762f925bdaddc4201f984)`
    - `BorrowingDisabledOnReserve(asset: 0xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f)`
...
- Targets:
  - 0x53d3D14F9B2B8FE12D0DA6864c76eD565716570e: Contract (not verified)
