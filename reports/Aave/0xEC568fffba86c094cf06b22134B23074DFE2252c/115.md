...
_Updated as of block [16963802](https://etherscan.io/block/16963802) at 4/2/2023, 4:35:35 PM ET_
...
- End Block: 15954738 (11/12/2022, 10:10:23 AM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/83d29e62-eb33-4a15-b286-4f3db5f4eadc](https://dashboard.tenderly.co/me/simulator/83d29e62-eb33-4a15-b286-4f3db5f4eadc)
...
- Targets:
  - 0x5e945515a8e1008DAC95404AeC9E12a9e65948F1: Contract (verified) (ProposalPayload)
...
- Touched address:
  - 0x5a3e063746e1cAC18Dbf46c4639532BACcFb2508: EOA (verification not applicable)
...
<details>
<summary>View warnings for ProposalPayload at `0x5e945515a8e1008DAC95404AeC9E12a9e65948F1`</summary>

```
ERROR:CryticCompile:ParserError: ParserError: Source "@openzeppelin/token/ERC20/IERC20.sol" not found: File not found. Searched the following locations: "".
 --> src/OneWayBondingCurve.sol:4:1:
  |
...
ParserError: ParserError: Source "@openzeppelin/token/ERC20/utils/SafeERC20.sol" not found: File not found. Searched the following locations: "".
 --> src/OneWayBondingCurve.sol:5:1:
  |
...
ParserError: ParserError: Source "@aave-address-book/AaveV2Ethereum.sol" not found: File not found. Searched the following locations: "".
 --> src/OneWayBondingCurve.sol:7:1:
  |
7 | import {AaveV2Ethereum} from "@aave-address-book/AaveV2Ethereum.sol";
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^


ParserError: ParserError: Source "@aave-address-book/AaveV2Ethereum.sol" not found: File not found. Searched the following locations: "".
 --> src/ProposalPayload.sol:6:1:
  |
6 | import {AaveV2Ethereum} from "@aave-address-book/AaveV2Ethereum.sol";
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
<details>
<summary>Slither report for ProposalPayload at `0x5e945515a8e1008DAC95404AeC9E12a9e65948F1`</summary>
...
crytic_compile.platform.exceptions.InvalidCompilation: ParserError: ParserError: Source "@openzeppelin/token/ERC20/IERC20.sol" not found: File not found. Searched the following locations: "".
 --> src/OneWayBondingCurve.sol:4:1:
  |
4 | import {IERC20} from "@openzeppelin/token/ERC20/IERC20.sol";
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ERROR:root:Error in 0x5e945515a8e1008DAC95404AeC9E12a9e65948F1
ERROR:root:Traceback (most recent call last):
  File "/home/runner/.local/lib/python3.10/site-packages/slither/__main__.py", line 837, in main_impl
    ) = process_all(filename, args, detector_classes, printer_classes)
  File "/home/runner/.local/lib/python3.10/site-packages/slither/__main__.py", line 90, in process_all
