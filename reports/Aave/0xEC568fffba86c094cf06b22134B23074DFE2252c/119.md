...
- Start Block: 15971584 (11/14/2022, 6:32:47 PM ET)
- End Block: 15990784 (11/17/2022, 10:57:59 AM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/99b5ac49-c70c-454b-a7c2-103139e63abe](https://dashboard.tenderly.co/me/simulator/99b5ac49-c70c-454b-a7c2-103139e63abe)
...
Freeze BAL market on Aave V2 ETH. Given that the market situation of BAL is currently volatile, out of an abundance of caution, we recommend temporarily freezing BAL.

## Implementation

We freeze the BAL market by calling the `freezeReserve` method on the `LendingPoolConfigurator`
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756` with implementation LendingPoolConfigurator at `0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521`
    - `ReserveFrozen(asset: 0xba100000625a3754423978a60c9317c58a424e3d)`
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.10.8/x64/lib/python3.10/os.py", line 225, in makedirs
    mkdir(name, mode)
FileExistsError: [Errno 17] File exists: 'crytic-export/etherscan-contracts/0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9-InitializableAdminUpgradeabilityProxy/contracts/open-zeppelin'
```
