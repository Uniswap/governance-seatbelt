...
- Simulation: [https://dashboard.tenderly.co/me/simulator/15558113-c845-4bf7-b5a1-4d940597bfe6](https://dashboard.tenderly.co/me/simulator/15558113-c845-4bf7-b5a1-4d940597bfe6)
...
```
ERROR:CryticCompile:Warning: contracts/dependencies/openzeppelin/upgradeability/InitializableUpgradeabilityProxy.sol: Warning: SPDX license identifier not provided in source file. Before publishing, consider adding a comment containing "SPDX-License-Identifier: <SPDX-License>" to each source file. Use "SPDX-License-Identifier: UNLICENSED" for non-open-source code. Please see https://spdx.org for more information.

Warning: contracts/dependencies/openzeppelin/upgradeability/InitializableUpgradeabilityProxy.sol: Warning: Source file does not specify required compiler version! Consider adding "pragma solidity ^0.6.12;"

DeclarationError: contracts/dependencies/openzeppelin/upgradeability/InitializableAdminUpgradeabilityProxy.sol:14:3: DeclarationError: Identifier not found or not unique.
...
Reentrancy in AIP27AMPL.execute() (contracts/assetListing/AIP27AMPL.sol#27-32):
	External calls:
	- LENDING_POOL_CONFIGURATOR_V2.setReserveFactor(token,1000) (contracts/assetListing/AIP27AMPL.sol#30)
	Event emitted after the call(s):
	- ProposalExecuted() (contracts/assetListing/AIP27AMPL.sol#31)
...
Constant AIP27AMPL.token (contracts/assetListing/AIP27AMPL.sol#22) is not in UPPER_CASE_WITH_UNDERSCORES
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions[0m
0xe8ec5c8cC613cf4B574e81fec05cA2663700AB90 analyzed (12 contracts with 78 detectors), 17 result(s) found
```
