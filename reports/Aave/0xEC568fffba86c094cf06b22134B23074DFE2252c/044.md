...
- Simulation: [https://dashboard.tenderly.co/me/simulator/f9ba5a15-ec1e-4987-967c-4d13d3229fb1](https://dashboard.tenderly.co/me/simulator/f9ba5a15-ec1e-4987-967c-4d13d3229fb1)
...
@@ `_reserves` key `0x004375dff511095cc5a197a54140a24efef3a416`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0x004375dff511095cc5a197a54140a24efef3a416` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0x1eff8af5d577060ba4ac8a29a13525bb0ee2a3d5`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0x1eff8af5d577060ba4ac8a29a13525bb0ee2a3d5` (symbol: BPT)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0x2fdbadf3c4d5a8666bc06645b8358ab803996e28`.configuration.data @@
- 27670193284100463268744
+ 27670337399288539124616

# decoded configuration.data for key `0x2fdbadf3c4d5a8666bc06645b8358ab803996e28` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0x3da1313ae46132a397d90d95b1424a9a7e3e0fce`.configuration.data @@
- 27670193284100463268744
+ 27670337399288539124616

# decoded configuration.data for key `0x3da1313ae46132a397d90d95b1424a9a7e3e0fce` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0x43ae24960e5534731fc831386c07755a2dc33d47`.configuration.data @@
- 36893565320955239075744
+ 36893709436143314931616

# decoded configuration.data for key `0x43ae24960e5534731fc831386c07755a2dc33d47` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0x59a19d8c652fa0284f44113d0ff9aba70bd46fb4`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0x59a19d8c652fa0284f44113d0ff9aba70bd46fb4` (symbol: BPT)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0x8bd1661da98ebdd3bd080f0be4e6d9be8ce9858c`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0x8bd1661da98ebdd3bd080f0be4e6d9be8ce9858c` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xa2107fa5b38d9bbd2c461d6edf11b11a50f6b974`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0xa2107fa5b38d9bbd2c461d6edf11b11a50f6b974` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xa478c2975ab1ea89e8196811f51a7b7ade33eb11`.configuration.data @@
- 18446821247245752997744
+ 18446965362433828853616

# decoded configuration.data for key `0xa478c2975ab1ea89e8196811f51a7b7ade33eb11` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xae461ca67b15dc8dc81ce7615e0320da1a9ab8d5`.configuration.data @@
- 18446821247245752997744
+ 18446965362433828853616

# decoded configuration.data for key `0xae461ca67b15dc8dc81ce7615e0320da1a9ab8d5` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc`.configuration.data @@
- 18446821247245752997744
+ 18446965362433828853616

# decoded configuration.data for key `0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xb6909b960dbbe7392d405429eb2b3649752b4838`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0xb6909b960dbbe7392d405429eb2b3649752b4838` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xbb2b8038a1640196fbe3e38816f3e67cba72d940`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0xbb2b8038a1640196fbe3e38816f3e67cba72d940` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xc2adda861f89bbb333c90c492cb837741916a225`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0xc2adda861f89bbb333c90c492cb837741916a225` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xd3d2e2692501a5c9ca623199d38826e513033a17`.configuration.data @@
- 27670193284100528805744
+ 27670337399288604661616

# decoded configuration.data for key `0xd3d2e2692501a5c9ca623199d38826e513033a17` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true

@@ `_reserves` key `0xdfc14d2af169b0d36c4eff567ada9b2e0cae044f`.configuration.data @@
- 9223449210390977189744
+ 9223593325579053045616

# decoded configuration.data for key `0xdfc14d2af169b0d36c4eff567ada9b2e0cae044f` (symbol: UNI-V2)
@@ configuration.data.frozen @@
- false
+ true
