...
_Updated as of block [16488799](https://etherscan.io/block/16488799) at 1/26/2023, 12:07:35 AM ET_
...
- Start Block: 16469007 (1/23/2023, 5:48:11 AM ET)
- End Block: 16488207 (1/25/2023, 10:08:59 PM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/14379460-5f7a-4a5a-8257-e60fc0687244](https://dashboard.tenderly.co/me/simulator/14379460-5f7a-4a5a-8257-e60fc0687244)
...
- Targets:
  - 0xC5A0BA13A3749c5d4a21934df8Fd64821AC3fCE7: Contract (verified) (AaveV3EthereumInitialPayload)
...
<details>
<summary>View warnings for AaveV3EthereumInitialPayload at `0xC5A0BA13A3749c5d4a21934df8Fd64821AC3fCE7`</summary>
...
ParserError: ParserError: Source "aave-address-book/AaveV3Ethereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/AaveV3EthereumInitialPayload.sol:4:1:
  |
...
ParserError: ParserError: Source "aave-address-book/AaveGovernanceV2.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/AaveV3EthereumInitialPayload.sol:5:1:
  |
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumAAVESteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^


ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumDAISteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumLINKSteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumUSDCSteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumWBTCSteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumWETHSteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/AaveV3EthereumWSTETHSteward.sol:4:1:
  |
4 | import {IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-address-book/AaveV3Ethereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/BaseV3EthereumWithPoolAdmin.sol:4:1:
  |
4 | import {AaveV3Ethereum} from 'aave-address-book/AaveV3Ethereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ParserError: ParserError: Source "aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol" not found: File not found. Searched the following locations: "".
 --> src/contracts/stewards/BaseV3EthereumWithPoolAdmin.sol:5:1:
  |
5 | import {AaveV3ListingEthereum, IGenericV3ListingEngine} from 'aave-helpers/v3-listing-engine/AaveV3ListingEthereum.sol';
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
<details>
<summary>Slither report for AaveV3EthereumInitialPayload at `0xC5A0BA13A3749c5d4a21934df8Fd64821AC3fCE7`</summary>
...
Error in 0xC5A0BA13A3749c5d4a21934df8Fd64821AC3fCE7
Traceback (most recent call last):
  File "/home/runner/.local/lib/python3.10/site-packages/slither/__main__.py", line 834, in main_impl
    ) = process_all(filename, args, detector_classes, printer_classes)
  File "/home/runner/.local/lib/python3.10/site-packages/slither/__main__.py", line 87, in process_all
