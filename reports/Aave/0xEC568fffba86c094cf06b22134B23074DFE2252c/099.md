...
- Simulation: [https://dashboard.tenderly.co/me/simulator/96a97d79-dd93-4c9a-acb7-d10eb304f241](https://dashboard.tenderly.co/me/simulator/96a97d79-dd93-4c9a-acb7-d10eb304f241)
...
```
ERROR:CryticCompile:Warning: contracts/interfaces/IERC20.sol: Warning: SPDX license identifier not provided in source file. Before publishing, consider adding a comment containing "SPDX-License-Identifier: <SPDX-License>" to each source file. Use "SPDX-License-Identifier: UNLICENSED" for non-open-source code. Please see https://spdx.org for more information.
...
Warning: contracts/interfaces/IERC20.sol: Warning: Source file does not specify required compiler version! Consider adding "pragma solidity ^0.6.10;"

DeclarationError: contracts/interfaces/IERC20Detailed.sol:4:1: DeclarationError: Declaration "IERC20" not found in "contracts/interfaces/IERC20.sol" (referenced as "./IERC20.sol").
