...
_Updated as of block [14854155](https://etherscan.io/block/14854155) at 5/27/2022, 8:27:35 AM ET_
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/cdb57e87-6f36-426d-a600-8924d8fab874](https://dashboard.tenderly.co/me/simulator/cdb57e87-6f36-426d-a600-8924d8fab874)
...
@@ _totalSupply @@
- 3106045056372655295920147
+ 3111690056550197803367453
@@ Slot `0x2dfea4d26ae12ec86bef88e9ad5401cfe29f0cdab93e593879eb61068442f392` @@
- "0x000000000000000000000000000000000000000000000001677f4d9da4c2192b"
+ "0x0000000000000000000000000000000000000000000000016781c01cd99e632f"
@@ Slot `0x2dfea4d26ae12ec86bef88e9ad5401cfe29f0cdab93e593879eb61068442f391` @@
- "0x000000000000000000000000610cd25d000000000000000000169d9b83958685"
+ "0x0000000000000000000000006111f348000000000000000000169d9b83958685"
...
@@ `_votingSnapshots` key `0x25f2226b597e8f9514b3f68f00f494cf4f286491`."14417".blockNumber @@
- 0
+ 12988951

@@ `_votingSnapshots` key `0x4da27a545c0c5b758a6ba100e3a049001de870f5`."37352".blockNumber @@
- 0
+ 12988951
...
@@ `_propositionPowerSnapshots` key `0x25f2226b597e8f9514b3f68f00f494cf4f286491`."10753".blockNumber @@
- 0
+ 12988951

@@ `_propositionPowerSnapshots` key `0x4da27a545c0c5b758a6ba100e3a049001de870f5`."26159".blockNumber @@
- 0
+ 12988951
...
- 2514640872782379904173169
+ 2508995872604837396725863

@@ `_balances` key `0x4da27a545c0c5b758a6ba100e3a049001de870f5` @@
- 3106050526372655295920147
+ 3111695526550197803367453
...
- 100149
+ 100150
@@ `streams` key `"100149"`.deposit @@
- 0
+ 2822500177542507447306
@@ `streams` key `"100149"`.ratePerSecond @@
- 0
+ 177542522141706
@@ `streams` key `"100149"`.remainingBalance @@
- 0
+ 2822500177542507447306
@@ `streams` key `"100149"`.startTime @@
- 0
+ 1629010800
@@ `streams` key `"100149"`.stopTime @@
- 0
+ 1644908401
@@ `streams` key `"100149"`.recipient @@
- 0x0000000000000000000000000000000000000000
+ 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba
@@ `streams` key `"100149"`.sender @@
- 0x0000000000000000000000000000000000000000
+ 0xee56e2b3d491590b5b31738cc34d5232f378a8d5
@@ `streams` key `"100149"`.tokenAddress @@
- 0x0000000000000000000000000000000000000000
...
- Events Emitted:
    - InitializableAdminUpgradeabilityProxy at `0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9`
        - `DelegatedPowerChanged(user: 0x25f2226b597e8f9514b3f68f00f494cf4f286491, amount: 2508995872604837396725863, delegationType: 0)`
        - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 5645000177542507447306, delegationType: 0)`
        - `DelegatedPowerChanged(user: 0x25f2226b597e8f9514b3f68f00f494cf4f286491, amount: 2508995872604837396725863, delegationType: 1)`
        ...
        - `DelegatedPowerChanged(user: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, amount: 3111695526550197803367453, delegationType: 0)`
        - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 0, delegationType: 1)`
        - `DelegatedPowerChanged(user: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, amount: 3111695526550197803367453, delegationType: 1)`
    ...
    - InitializableAdminUpgradeabilityProxy at `0x4da27a545c0c5B758a6BA100e3a049001de870f5`
        - `AssetIndexUpdated(asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25905197761754456879)`
        - `UserIndexUpdated(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25905197761754456879)`
        - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 5645000177542507447306, delegationType: 0)`
        - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 5645000177542507447306, delegationType: 1)`
        ...
        - `UserIndexUpdated(user: 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba, asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25905197761754456879)`
        ...
        - `UserIndexUpdated(user: 0xcd18eaa163733da39c232722cbc4e8940b1d8888, asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25905197761754456879)`
        - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 0, delegationType: 0)`
    ...
    - Sablier at `0xCD18eAa163733Da39c232722cBC4E8940b1D8888`
        - `CreateStream(streamId: 100149, sender: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, recipient: 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba, deposit: 2822500177542507447306, tokenAddress: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, startTime: 1629010800, stopTime: 1644908401)`
