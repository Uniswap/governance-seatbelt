...
- Start Block: 15965387 (11/13/2022, 9:48:11 PM ET)
- End Block: 15984587 (11/16/2022, 3:21:52 PM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/e018feb8-f4f6-458f-9098-3b27491bf530](https://dashboard.tenderly.co/me/simulator/e018feb8-f4f6-458f-9098-3b27491bf530)
...
Freeze REN market on Aave V2 ETH.

## Implementation

We freeze the REN market by calling the `freezeReserve` method on the `LendingPoolConfigurator`
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756` with implementation LendingPoolConfigurator at `0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521`
    - `ReserveFrozen(asset: 0x408e41876cccdc0f92210600ef50372656052a38)`
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.10.8/x64/lib/python3.10/os.py", line 225, in makedirs
    mkdir(name, mode)
FileExistsError: [Errno 17] File exists: 'crytic-export/etherscan-contracts/0xB53C1a33016B2DC2fF3653530bfF1848a515c8c5-LendingPoolAddressesProvider/contracts/protocol/libraries/aave-upgradeability'
```
