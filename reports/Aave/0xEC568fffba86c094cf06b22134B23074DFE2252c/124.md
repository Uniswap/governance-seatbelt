...
_Updated as of block [16043490](https://etherscan.io/block/16043490) at 11/24/2022, 7:41:59 PM ET_
...
- Start Block: 16044555 (11/24/2022, 11:32:44 PM ET)
- End Block: 16063755 (11/27/2022, 8:52:44 PM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/ddb5b5fe-66eb-4468-bdbb-1687f7b8c988](https://dashboard.tenderly.co/me/simulator/ddb5b5fe-66eb-4468-bdbb-1687f7b8c988)

### Subreports

- [PolygonBridgeExecution](/reports/Aave/0xEC568fffba86c094cf06b22134B23074DFE2252c/124_fx_7_0.md)
...
A proposal to make parameter changes on Aave V2 Polygon.

## Motivation

Aave V2 lacks many of the risk controls that Aave V3 solves for (supply caps, borrow caps, isolation mode, e-mode, etc.). Given that the market situation of these assets is currently volatile, out of an abundance of caution, we recommend freezing the following markets on Aave V2 Polygon and promote migration to V3. These recommendations are in line with the rationale of [AIP 121](https://app.aave.com/governance/proposal/?proposalId=121).
...
The proposal enacts changes by using the CrosschainForwarderPolygon located at `0x158a6bC04F0828318821baE797f50B0A1299d45b` in order to call the `execute()` method on the following payload, which enacts changes on Aave V2 on Polygon:

- `0x31976DC2Ea27E75cC5a3687ED594D17127f9b72E`
...
- Events Emitted:
  - StateSender at `0x28e4F3a7f651294B9564800b2D01f35189A5bFbE`
    - `StateSynced(id: 2449455, contractAddress: 0x8397259c983751daf40400790063935a11afa28a, data: )`
...
crytic_compile.platform.exceptions.InvalidCompilation: Invalid solc compilation Traceback (most recent call last):
  File "/opt/hostedtoolcache/Python/3.10.8/x64/bin/solc", line 8, in <module>
    sys.exit(solc())
  File "/opt/hostedtoolcache/Python/3.10.8/x64/lib/python3.10/site-packages/solc_select/__main__.py", line 84, in solc
    halt_old_architecture(path)
  File "/opt/hostedtoolcache/Python/3.10.8/x64/lib/python3.10/site-packages/solc_select/solc_select.py", line 27, in halt_old_architecture
