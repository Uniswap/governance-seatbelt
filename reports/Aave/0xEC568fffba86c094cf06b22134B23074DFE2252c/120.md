...
_Updated as of block [16023078](https://etherscan.io/block/16023078) at 11/21/2022, 11:11:23 PM ET_
...
- Start Block: 16030143 (11/23/2022, 12:42:08 AM ET)
- End Block: 16049343 (11/25/2022, 10:02:08 PM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/5cce97bf-99f2-4abc-ad59-8f804e4b147c](https://dashboard.tenderly.co/me/simulator/5cce97bf-99f2-4abc-ad59-8f804e4b147c)
...
Gauntlet's simulation engine will continue to adjust risk parameters to protect against outsized market risk while optimizing for capital efficiency.

These parameter recommendations reflect the unique situation of REN in the current market conditions.

![](https://i.imgur.com/nJyy91U.png)

## Implementation

The proposal sets the LTV and liquidation threshold ratios by calling `configureReserveAsCollateral` on the `LendingPoolConfigurator` using the address and parameters specific to each token.

The full list of parameter updates can be found in the [forum](https://governance.aave.com/t/arc-risk-parameter-updates-for-aave-v2-eth-and-aave-arc-fireblocks-2022-11-17/10688).
...
- 36894285893674425653104
+ 36894285893674392884604
