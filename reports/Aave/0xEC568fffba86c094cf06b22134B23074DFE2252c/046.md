...
_Updated as of block [15118284](https://etherscan.io/block/15118284) at 7/10/2022, 9:07:49 PM ET_
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/c4a9d1ce-9bcd-4379-886c-a79048b2f358](https://dashboard.tenderly.co/me/simulator/c4a9d1ce-9bcd-4379-886c-a79048b2f358)
...
@@ `_votingSnapshotsCounts` key `0x683a4f9915d6216f73d6df50151725036bd26c02` @@
- 2
+ 3
...
- 10987913213012903675
+ 43442837143196680718

@@ `stakerRewardsToClaim` key `0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba` @@
- 10981002027526936036
+ 50289115881741834225

@@ `_propositionPowerSnapshotsCounts` key `0x683a4f9915d6216f73d6df50151725036bd26c02` @@
- 3
+ 4
...
- 2552053914584578098450
+ 5522054292331824970502

@@ `_balances` key `0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba` @@
- 3090946262957929348856
+ 6060946262957929348856

@@ _totalSupply @@
- 3097020865238670874902894
+ 3102960865616418121774946
@@ `_propositionPowerSnapshots` key `0x683a4f9915d6216f73d6df50151725036bd26c02`."3".blockNumber @@
- 0
+ 13603488
...
@@ `_votingSnapshots` key `0x683a4f9915d6216f73d6df50151725036bd26c02`."2".blockNumber @@
- 0
+ 13603488
...
- "0x000000000000000000000000618ad4ac000000000000000000169d9b83958685"
+ "0x000000000000000000000000618ffa61000000000000000000169d9b83958685"
@@ Slot `0x9c3a604dc0f745677aec95b6903bd25e96301e76e766abfd2ab86b5d61967f08` @@
- "0x000000000000000000000000000000000000000000000001678ff65d504b1514"
+ "0x00000000000000000000000000000000000000000000000167bd24920e4b8c8c"
...
- "0x00000000000000000000000000000000000000000000000167baadf4cb3c9a55"
+ "0x00000000000000000000000000000000000000000000000167bd24920e4b8c8c"
...
@@ `_votingSnapshots` key `0x25f2226b597e8f9514b3f68f00f494cf4f286491`."17160".blockNumber @@
- 0
+ 13603488

@@ `_votingSnapshots` key `0x4da27a545c0c5b758a6ba100e3a049001de870f5`."44532".blockNumber @@
- 0
+ 13603488
...
@@ `_propositionPowerSnapshots` key `0x25f2226b597e8f9514b3f68f00f494cf4f286491`."13496".blockNumber @@
- 0
+ 13603488

@@ `_propositionPowerSnapshots` key `0x4da27a545c0c5b758a6ba100e3a049001de870f5`."33339".blockNumber @@
- 0
+ 13603488
...
- 2233223556292786769116533
+ 2227283555915039522244481

@@ `_balances` key `0x4da27a545c0c5b758a6ba100e3a049001de870f5` @@
- 3097026335238670874902894
+ 3102966335616418121774946
...
- 101266
+ 101267
@@ `streams` key `"101266"`.deposit @@
- 0
+ 2970000377747246872052
@@ `streams` key `"101266"`.ratePerSecond @@
- 0
+ 377747252747252
@@ `streams` key `"101266"`.remainingBalance @@
- 0
+ 2970000377747246872052
@@ `streams` key `"101266"`.startTime @@
- 0
+ 1637049600
@@ `streams` key `"101266"`.stopTime @@
- 0
+ 1644912001
@@ `streams` key `"101266"`.recipient @@
- 0x0000000000000000000000000000000000000000
+ 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba
@@ `streams` key `"101266"`.sender @@
- 0x0000000000000000000000000000000000000000
+ 0xee56e2b3d491590b5b31738cc34d5232f378a8d5
@@ `streams` key `"101266"`.tokenAddress @@
- 0x0000000000000000000000000000000000000000
...
- Events Emitted:
  - InitializableAdminUpgradeabilityProxy at `0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9`
    - `DelegatedPowerChanged(user: 0x25f2226b597e8f9514b3f68f00f494cf4f286491, amount: 2227283555915039522244481, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 5940000377747246872052, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0x25f2226b597e8f9514b3f68f00f494cf4f286491, amount: 2227283555915039522244481, delegationType: 1)`
    ...
    - `DelegatedPowerChanged(user: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, amount: 3102966335616418121774946, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 0, delegationType: 1)`
    - `DelegatedPowerChanged(user: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, amount: 3102966335616418121774946, delegationType: 1)`
  ...
  - InitializableAdminUpgradeabilityProxy at `0x4da27a545c0c5B758a6BA100e3a049001de870f5`
    - `AssetIndexUpdated(asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25921915239938100364)`
    - `UserIndexUpdated(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25921915239938100364)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 5940000377747246872052, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 5940000377747246872052, delegationType: 1)`
    ...
    - `UserIndexUpdated(user: 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba, asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25921915239938100364)`
    - `RewardsAccrued(user: 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba, amount: 39308113854214898189)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 2970000377747246872052, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0x683a4f9915d6216f73d6df50151725036bd26c02, amount: 6060946262957929348856, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 2970000377747246872052, delegationType: 1)`
    - `DelegatedPowerChanged(user: 0x683a4f9915d6216f73d6df50151725036bd26c02, amount: 195934873497382050897786, delegationType: 1)`
    ...
    - `UserIndexUpdated(user: 0xcd18eaa163733da39c232722cbc4e8940b1d8888, asset: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, index: 25921915239938100364)`
    - `RewardsAccrued(user: 0xcd18eaa163733da39c232722cbc4e8940b1d8888, amount: 32454923930183777043)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 0, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xcd18eaa163733da39c232722cbc4e8940b1d8888, amount: 5522054292331824970502, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, amount: 0, delegationType: 1)`
    - `DelegatedPowerChanged(user: 0xcd18eaa163733da39c232722cbc4e8940b1d8888, amount: 5522054292331824970502, delegationType: 1)`
  ...
  - Sablier at `0xCD18eAa163733Da39c232722cBC4E8940b1D8888`
    - `CreateStream(streamId: 101266, sender: 0xee56e2b3d491590b5b31738cc34d5232f378a8d5, recipient: 0xd20c9667bf0047f313228f9fe11f8b9f8dc29bba, deposit: 2970000377747246872052, tokenAddress: 0x4da27a545c0c5b758a6ba100e3a049001de870f5, startTime: 1637049600, stopTime: 1644912001)`
