...
_Updated as of block [15686259](https://etherscan.io/block/15686259) at 10/5/2022, 11:04:35 PM ET_
...
- End Block: 15701802 (10/8/2022, 7:12:14 AM ET)
...
- Simulation: [https://dashboard.tenderly.co/me/simulator/15ef0175-12d5-407e-8427-d2464ac03749](https://dashboard.tenderly.co/me/simulator/15ef0175-12d5-407e-8427-d2464ac03749)
...
- 1520711158058067288971220
+ 1518897478058067288971220

@@ `_balances` key `0xb428c6812e53f843185986472bb7c1e25632e0f7` @@
- 0
+ 1813680000000000000000

@@ `_votingSnapshots` key `0x25f2226b597e8f9514b3f68f00f494cf4f286491`."25138".blockNumber @@
- 0
+ 15701804
...
@@ `_propositionPowerSnapshots` key `0x25f2226b597e8f9514b3f68f00f494cf4f286491`."21474".blockNumber @@
- 0
+ 15701804
...
- "0x0000633e450300001d983b1ea328dd36a2876300000000000006c300f71c5b30"
...
- Events Emitted:
  ...
  - InitializableImmutableAdminUpgradeabilityProxy at `0xBcca60bB61934080951369a648Fb03DF4F96263C`
    - `BalanceTransfer(from: 0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c, to: 0xb428c6812e53f843185986472bb7c1e25632e0f7, value: 350000000000, index: 1077900510922563936291812659)`
  ...
  - InitializableAdminUpgradeabilityProxy at `0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9` with implementation AaveTokenV2 (Aave Token) at `0xC13eac3B4F9EED480045113B7af00F7B5655Ece8`
    - `DelegatedPowerChanged(user: 0x25f2226b597e8f9514b3f68f00f494cf4f286491, amount: 1518897478058067288971220, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0xb428c6812e53f843185986472bb7c1e25632e0f7, amount: 1813680000000000000000, delegationType: 0)`
    - `DelegatedPowerChanged(user: 0x25f2226b597e8f9514b3f68f00f494cf4f286491, amount: 1518897478058067288971220, delegationType: 1)`
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/site-packages/crytic_compile/platform/etherscan.py", line 268, in compile
    with urllib.request.urlopen(etherscan_url) as response:
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/urllib/request.py", line 216, in urlopen
    return opener.open(url, data, timeout)
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/urllib/request.py", line 525, in open
    response = meth(req, response)
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/urllib/request.py", line 634, in http_response
    response = self.parent.error(
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/urllib/request.py", line 563, in error
    return self._call_chain(*args)
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/urllib/request.py", line 496, in _call_chain
    result = func(*args)
  File "/opt/hostedtoolcache/Python/3.10.7/x64/lib/python3.10/urllib/request.py", line 643, in http_error_default
