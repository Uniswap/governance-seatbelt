...
- Start Block: 12960301 (8/4/2021, 2:37:36 PM ET)
- End Block: 12979501 (8/7/2021, 2:07:34 PM ET)
- Targets: [0xBa4b807a72516C1E94D5191616A03cF12a2B0362](https://etherscan.io/address/0xBa4b807a72516C1E94D5191616A03cF12a2B0362#code)
- Executor: [0xEE56e2B3D491590B5b31738cC34d5232F378a8D5](https://etherscan.io/address/0xEE56e2B3D491590B5b31738cC34d5232F378a8D5) (Short executor)
- Simulation: [https://dashboard.tenderly.co/me/simulator/4735c61d-09ac-449b-a3d5-84bb339d241d](https://dashboard.tenderly.co/me/simulator/4735c61d-09ac-449b-a3d5-84bb339d241d)
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756`
    - `ReserveInterestRateStrategyChanged(asset: 0xd46ba6d942050d489dbd938a2c909a5d5039a161, strategy: 0x509859687725398587147dd7a2c88d7316f92b02)`
...
- Targets:
  - 0xBa4b807a72516C1E94D5191616A03cF12a2B0362: Contract (verified) (AIP26AMPL)
...
- Touched address:
  - 0x5A617f363674489339226E8A448307763a43108F: EOA (verification not applicable)
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.10.5/x64/lib/python3.10/site-packages/crytic_compile/platform/etherscan.py", line 306, in compile
    filenames, working_dir = _handle_multiple_files(
  File "/opt/hostedtoolcache/Python/3.10.5/x64/lib/python3.10/site-packages/crytic_compile/platform/etherscan.py", line 158, in _handle_multiple_files
    os.makedirs(path_filename.parent)
  File "/opt/hostedtoolcache/Python/3.10.5/x64/lib/python3.10/os.py", line 225, in makedirs
    mkdir(name, mode)
FileExistsError: [Errno 17] File exists: 'crytic-export/etherscan-contracts/0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521-LendingPoolConfigurator/contracts/protocol/lendingpool'
```
...
- No compiler warnings for AIP26AMPL at `0xBa4b807a72516C1E94D5191616A03cF12a2B0362`
...
- Slither report for AIP26AMPL at `0xBa4b807a72516C1E94D5191616A03cF12a2B0362`

<details>
<summary>View report for AIP26AMPL at `0xBa4b807a72516C1E94D5191616A03cF12a2B0362`</summary>
...
Reentrancy in AIP26AMPL.execute() (contracts/assetListing/AIP26AMPL.sol#28-33):
	External calls:
	- LENDING_POOL_CONFIGURATOR_V2.setReserveInterestRateStrategyAddress(token,interestStrategy) (contracts/assetListing/AIP26AMPL.sol#31)
	Event emitted after the call(s):
	- ProposalExecuted() (contracts/assetListing/AIP26AMPL.sol#32)
...
Constant AIP26AMPL.token (contracts/assetListing/AIP26AMPL.sol#22) is not in UPPER_CASE_WITH_UNDERSCORES
Constant AIP26AMPL.interestStrategy (contracts/assetListing/AIP26AMPL.sol#23) is not in UPPER_CASE_WITH_UNDERSCORES
...
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions[0m
0xBa4b807a72516C1E94D5191616A03cF12a2B0362 analyzed (11 contracts with 78 detectors), 15 result(s) found
```
