export const abi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'previousEthereumGovernanceExecutor', type: 'address' },
    ...
    outputs: [
      {
        ...
        internalType: 'struct ITimelockExecutor.ActionsSet',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'enum ITimelockExecutor.ActionsSetState', name: '', type: 'uint8' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
