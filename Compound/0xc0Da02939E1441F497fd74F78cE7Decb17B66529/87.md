...
- End Block: 14388652 (3/14/2022, 10:41:00 PM ET)
...
Warnings:
- Could not read address of governor implementation at block `14388653`. Make sure the `RPC_URL` is an archive node. As a result the Slither check will show warnings on the governor's implementation contract.
