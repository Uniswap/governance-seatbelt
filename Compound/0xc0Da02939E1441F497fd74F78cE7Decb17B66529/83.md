...
_Updated as of block [14127885](https://etherscan.io/block/14127885) at 2/2/2022, 12:08:16 PM ET_
...
- End Block: 14130852 (2/2/2022, 10:51:07 PM ET)
...
```
Compilation warnings/errors on ./ICore.sol:
[91mError: Source "token/IFei.sol" not found: File not found.[0m
 --> ./ICore.sol:5:1:
  |
5 | import "../token/IFei.sol";
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
crytic_compile.platform.exceptions.InvalidCompilation: Invalid solc compilation Error: Source "token/IFei.sol" not found: File not found.
 --> ./ICore.sol:5:1:
  |
5 | import "../token/IFei.sol";
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^
