...
- State changes:
    - Comp (Compound) at `0xc00e94Cb662C3520282E6f5717214004A7f26888`
        - `balances` key `0x3d9819210a31b4961b30ef54be2aed79b9c9cd3b` changed from `"71715295105101057256510"` to `"71710295105101057256510"`
        - `balances` key `0xcf0ef02c51438c821246f2e6ade50e0f1cb0f385` changed from `"6977000000000000000"` to `"11977000000000000000"`
        - `checkpoints` key `0xcf0ef02c51438c821246f2e6ade50e0f1cb0f385` changed from `{"1":{}}` to `{"1":{"fromBlock":14395323}}`
        - `numCheckpoints` key `0xcf0ef02c51438c821246f2e6ade50e0f1cb0f385` changed from `1` to `2`
...
- Events Emitted:
    ...
    - Comp (Compound) at `0xc00e94Cb662C3520282E6f5717214004A7f26888`
        ...
        - `DelegateVotesChanged(delegate: 0xcf0ef02c51438c821246f2e6ade50e0f1cb0f385, previousBalance: 6977000000000000000, newBalance: 11977000000000000000)`
