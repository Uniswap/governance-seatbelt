...
- End Block: 14415499 (3/19/2022, 2:40:36 AM ET)
...
Warnings:
- Could not read address of governor implementation at block `14415500`. Make sure the `RPC_URL` is an archive node. As a result the Slither check will show warnings on the governor's implementation contract.
