...
_Updated as of block [14596763](https://etherscan.io/block/14596763) at 4/16/2022, 10:02:24 AM ET_
...
CToken.doTransferOut(address,uint256) (contracts/CToken.sol#1443) is never used and should be removed
CToken.getCashPrior() (contracts/CToken.sol#1430) is never used and should be removed
...
0x3587b2F7E0E2D6166d6C14230e7Fe160252B0ba4 analyzed (20 contracts with 77 detectors), 139 result(s) found
```
