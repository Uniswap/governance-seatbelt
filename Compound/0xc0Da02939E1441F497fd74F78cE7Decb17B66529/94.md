...
- End Block: 14488675 (3/30/2022, 10:20:26 AM ET)
...
Errors:
- Transaction reverted with reason: deposit not multiple of time delta
...
Warnings:
- Could not read address of governor implementation at block `14488676`. Make sure the `RPC_URL` is an archive node. As a result the Slither check will show warnings on the governor's implementation contract.
